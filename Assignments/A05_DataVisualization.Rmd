...
all_plots <- plot_grid(temp + theme(legend.position = "none"), TP + theme(legend.position = "none"), TN + theme(legend.position = "none"), nrow=1)
print(all_plots)
...
plot_all_grid <- plot_grid(all_plots, cowplot_legend, nrow=2, rel_height = c(3, 0.3)) 
print(plot_all_grid)
