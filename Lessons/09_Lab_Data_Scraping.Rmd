...
#gsub = substitutes something for something else 
# in this examples, the comma is substituted with nothing
```
...
the_yests <- seq(2017, 2019)
the_dfs <- lappy(X= the_years, FUN = scrape.it) %>% bind_rows()

#tidyverse version to Map the function to scrape data from 2017 to 2020
