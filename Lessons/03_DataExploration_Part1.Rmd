...
<<<<<<< HEAD
USGS.flow.data <- read.csv("../Data/Raw/USGS_Site02085000_Flow_Raw.csv", stringsAsFactor = TRUE)
#***NEED TO USE THE STRINGSASFACTORS = TRUE to make THEM INTO STRINGS FOR VECTORS!!!!!!!
